...
class FrameRecorder {
  ...
  int currentFrame() => ui.PlatformDispatcher.instance.frameData.frameNumber;

  int get _latestReported => _buffer.isEmpty ? -1 : _buffer.last.frameNumber;
